## This code is in partial fulfillment of the requirements in "Programming 2: Lexical
## Scoping" of the "R Programming" course in Coursera.

## The goal of the following pair of functions is to cache the inverse of a matrix.

## Functions were created based on the given example, caching the mean of a vector.
...
## Moving forward with the assignment, the function below creates a special "matrix" 
